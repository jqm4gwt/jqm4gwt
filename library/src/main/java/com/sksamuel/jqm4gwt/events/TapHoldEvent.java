 ...
 */
public class TapHoldEvent extends JQueryBaseEvent<TapHoldHandler> {
	 ...
	 * @param jQueryEvent 
	 */
	public static void fire(HasTapHoldHandlers source, JavaScriptObject jQueryEvent) {
		if (TYPE != null) {
			TapHoldEvent event = new TapHoldEvent(jQueryEvent);
