...
public abstract class JQMForm extends FlowPanel {
	 ...
	 * 
	 * @param validator
	 *              the validator that will be invoked
	 * @param notifiedWidget
	 *              the widget that will be notified of the error. If null
	 ...
	 * 
	 * @param ui
	 *              the {@link UIObject} to change the stylesheet on
	 * 
